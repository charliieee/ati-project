...
| 5 | make_report_figs.py, make_report_figs.py, make_personas_docx.js | Internal report figures and Word deliverables (persona profiles, Supplementary Information). |
...
Random seeds are fixed (bootstrap and permutation procedures use numpy.random.default_rng(2026)); results in the paper are exactly reproducible
